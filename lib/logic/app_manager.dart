...
class AppManager {
  ...
  Future<T?> navigateTo<T>(BuildContext context, String name) async =>
      await Navigator.of(context).pushNamed<T>(name);

  Future<T?> openDialog<T>(BuildContext context, Widget child,
